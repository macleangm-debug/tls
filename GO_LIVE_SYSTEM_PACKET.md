...
CORS_ORIGINS=https://billing-dashboard-45.preview.emergentagent.com,http://localhost:3000
...
```
REACT_APP_BACKEND_URL=https://billing-dashboard-45.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
