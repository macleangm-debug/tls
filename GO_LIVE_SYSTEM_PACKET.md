...
CORS_ORIGINS=https://practice-vault-1.preview.emergentagent.com,http://localhost:3000
...
```
REACT_APP_BACKEND_URL=https://practice-vault-1.preview.emergentagent.com
WDS_SOCKET_PORT=443
```
