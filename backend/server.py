...
FRONTEND_URL = os.environ.get('FRONTEND_URL', 'https://practice-vault-1.preview.emergentagent.com')
...
async def generate_stamp_preview(
    ...
    preview_url = f"https://practice-vault-1.preview.emergentagent.com/verify?id={preview_stamp_id}"
...
async def embed_stamp_in_pdf_preview(content: bytes, stamp_record: dict, user: dict, position: dict) -> bytes:
    ...
    try:
        ...
        verification_url = f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://practice-vault-1.preview.emergentagent.com')}/verify?id={stamp_record['stamp_id']}"
        stamp_img = generate_branded_stamp_image(
...
async def create_document_stamp(
    ...
    verification_url = f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://practice-vault-1.preview.emergentagent.com')}/verify?id={stamp_id}"
...
async def get_stamp_detail(stamp_id: str, user: dict = Depends(get_current_user)):
    ...
    frontend_url = os.environ.get('REACT_APP_BACKEND_URL', 'https://practice-vault-1.preview.emergentagent.com')
