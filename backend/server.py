...
FRONTEND_URL = os.environ.get('FRONTEND_URL', 'https://billing-dashboard-45.preview.emergentagent.com')
...
async def generate_stamp_preview(
    ...
    preview_url = f"https://billing-dashboard-45.preview.emergentagent.com/verify?id={preview_stamp_id}"
...
async def create_document_stamp(
    ...
    verification_url = f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://billing-dashboard-45.preview.emergentagent.com')}/verify?id={stamp_id}"
...
async def get_stamp_detail(stamp_id: str, user: dict = Depends(get_current_user)):
    ...
    frontend_url = os.environ.get('REACT_APP_BACKEND_URL', 'https://billing-dashboard-45.preview.emergentagent.com')
