...
FRONTEND_URL = os.environ.get('FRONTEND_URL', 'https://case-management-hub-5.preview.emergentagent.com')
...
async def create_document_stamp(
    ...
    verification_url = f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://case-management-hub-5.preview.emergentagent.com')}/verify?id={stamp_id}"
...
async def embed_stamp_in_pdf(content: bytes, stamp_record: dict, user: dict, position: dict) -> bytes:
    ...
    try:
        ...
        verification_url = f"{os.environ.get('REACT_APP_BACKEND_URL', 'https://case-management-hub-5.preview.emergentagent.com')}/verify?id={stamp_record['stamp_id']}"
