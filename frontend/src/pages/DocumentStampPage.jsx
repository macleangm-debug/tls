...
const DocumentStampPage = () => {
  ...
  const [stampSize, setStampSize] = useState({ width: 100, height: 100 });
                              ...
                              return (
                                ...
                                >
                                  <div className="flex flex-col cursor-move stamp-drag-handle" style={{ touchAction: 'none' }}>
                                    {/* Dynamic Stamp Preview - FULLY TRANSPARENT with white only behind content */}
                                    <div 
                                ...
                                {(() => {
                                  ...
                                  // CIRCLE STAMP - Curved TLS VERIFIED, no logo, bigger QR
                                  if (stampShape === "circle") {
                                    const w = stampSize.width;
                                    const h = stampSize.height;
                                    const previewDate = new Date().toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' });
                                    return (
                                      <div 
                                      ...
                                      >
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-center justify-start pt-[15%]">
                                          {/* ★ TLS VERIFIED ★ - curved text simulation */}
                                          <span 
                                          ...
                                          <div className="flex flex-col items-center gap-0.5 mt-1">
                                            {/* QR Code box - BIGGER */}
                                            <div 
                                              className="bg-white p-1 rounded shadow-sm border-2"
                                              style={{ borderColor: brandColor }}
                                            >
                                              <div className="w-8 h-8 grid grid-cols-4 gap-[1px]">
                                                {[1,0,1,1,0,1,0,1,1,1,0,0,0,1,1,0].map((v, i) => (
                                                  <div 
                                                    key={i} 
                                                    className="rounded-sm"
                                                    style={{ backgroundColor: v ? brandColor : 'white' }} 
                                                  />
                                                ))}
                                              </div>
                                            </div>
                                            ...
                                            {/* Stamp ID - full */}
                                            <p className="text-[5px] font-bold" style={{ color: brandColor }}>
                                              {previewStampId}
                                            </p>
                                  ...
                                  // OVAL STAMP - Horizontal layout, no logo
                                  if (stampShape === "oval") {
                                    const previewDate = new Date().toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' });
                                    return (
                                      <div 
                                      ...
                                      >
                                        ...
                                        <div className="absolute inset-0 flex flex-col items-center justify-between py-[8%] px-[5%]">
                                          {/* ★ TLS VERIFIED ★ at top */}
                                          <span className="text-[6px] font-bold" style={{ color: brandColor }}>
                                            ★ TLS VERIFIED ★
                                          </span>
                                          ...
                                          <div className="flex items-center gap-2 w-full justify-center">
                                            {/* QR Code */}
                                            <div className="bg-white p-1 rounded border" style={{ borderColor: brandColor }}>
                                              <div className="w-6 h-6 grid grid-cols-4 gap-[1px]">
                                                {[1,0,1,1,0,1,0,1,1,1,0,0,0,1,1,0].map((v, i) => (
                                                  <div key={i} className="rounded-sm" style={{ backgroundColor: v ? brandColor : 'white' }} />
                                                ))}
                                              </div>
                                            </div>
                                            ...
                                            {/* Text info */}
                                            <div className="text-left">
                                              <p className="text-[5px] font-bold" style={{ color: brandColor }}>{previewStampId}</p>
                                              <p className="text-[4px] text-gray-600">{previewDate}</p>
                                              {showAdvocateName && (
                                                <p className="text-[5px] font-bold" style={{ color: brandColor }}>{user?.full_name || 'Advocate'}</p>
                                              )}
                                            </div>
                                          </div>
                                  ...
                                  // HORIZONTAL LAYOUT (Wide) - TRANSPARENT border, white content areas, with TLS Logo
                                  if (stampLayout === "horizontal") {
                                    return (
                                      <div className="w-full h-full rounded-sm border-2 overflow-hidden flex flex-col" style={{ borderColor: brandColor, backgroundColor: 'transparent' }}>
                                        <div className="px-2 py-1 flex items-center justify-between" style={{ backgroundColor: brandColor }}>
                                          <div className="bg-white rounded p-0.5 flex items-center justify-center w-6 h-6">
                                            <img src="/assets/tls-logo.png" alt="TLS" className="w-4 h-4 object-contain" onError={(e) => { e.target.innerHTML = '<span class="text-[5px] font-bold" style="color:' + brandColor + '">TLS</span>'; }} />
                                          </div>
                                          <div className="text-right">
                                            <p className="text-[7px] font-bold text-white">TLS VERIFIED</p>
                                          </div>
                                        </div>
                                        <div className="p-1.5 flex gap-1.5 flex-1 bg-white">
                                          {/* QR with white background for scannability */}
                                          <div className="w-10 h-10 rounded flex-shrink-0 p-0.5 bg-white" style={{ border: `1px solid ${brandColor}30` }}>
                                            <QRPatternPreview size="w-full h-full" />
                                          </div>
                                          <div className="flex-1 min-w-0 text-[5px]">
                                            <p className="text-gray-400">STAMP ID</p>
                                            <p className="font-bold truncate text-gray-800">{previewStampId}</p>
                                            <p className="text-gray-400 mt-0.5">DATE</p>
                                            <p className="text-gray-600">{previewDate}</p>
                                          </div>
                                        </div>
                                        {showAdvocateName && (
                                          <div className="px-1.5 pb-1 text-center bg-white">
                                            <p className="text-[5px] font-bold" style={{ color: brandColor }}>{user?.full_name || 'Advocate'}</p>
                                          </div>
                                        )}
                                        <div className="py-1 text-center bg-white border-t" style={{ borderColor: `${brandColor}30` }}>
                                          <p className="text-[8px] font-bold" style={{ color: brandColor }}>Scan to Verify</p>
                                        </div>
                                      </div>
                                    );
                                  }

                                  // VERTICAL LAYOUT (Tall) - TRANSPARENT with white content areas
                                  if (stampLayout === "vertical") {
                                    return (
                                      <div className="w-full h-full rounded-sm border-2 overflow-hidden flex flex-col" style={{ borderColor: brandColor, backgroundColor: 'transparent' }}>
                                        <div className="px-2 py-1.5 text-center" style={{ backgroundColor: brandColor }}>
                                          <p className="text-[6px] font-bold text-white">TLS</p>
                                          <p className="text-[7px] font-bold text-white">VERIFIED</p>
                                        </div>
                                        <div className="flex-1 flex flex-col items-center justify-center p-1.5 gap-1 bg-white">
                                          {/* QR with white background */}
                                          <div className="w-10 h-10 rounded p-0.5 bg-white" style={{ border: `1px solid ${brandColor}30` }}>
                                            <QRPatternPreview size="w-full h-full" />
                                          </div>
                                          <p className="text-[5px] font-mono text-gray-600">{previewStampId}</p>
                                          <p className="text-[5px] text-gray-400">{previewDate}</p>
                                        </div>
                                        {showAdvocateName && (
                                          <div className="text-center pb-1 bg-white">
                                            <p className="text-[5px] font-bold" style={{ color: brandColor }}>{user?.full_name?.split(' ')[0] || 'Advocate'}</p>
                                          </div>
                                        )}
                                        <div className="py-0.5 text-center bg-white">
                                          <p className="text-[6px] font-semibold" style={{ color: brandColor }}>Scan to Verify</p>
                                        </div>
                                      </div>
                                    );
                                  }

                                  // COMPACT LAYOUT (Mini) - TRANSPARENT
                                  if (stampLayout === "compact") {
                                    return (
                                      <div className="w-full h-full rounded-sm border-2 overflow-hidden flex" style={{ borderColor: brandColor, backgroundColor: 'transparent' }}>
                                        <div className="w-1/3 flex items-center justify-center" style={{ backgroundColor: brandColor }}>
                                          <QRPatternPreview size="w-8 h-8" onColoredBg={true} />
                                        </div>
                                        <div className="flex-1 p-1 flex flex-col justify-center bg-white">
                                          <p className="text-[6px] font-bold" style={{ color: brandColor }}>TLS VERIFIED</p>
                                          <p className="text-[5px] font-mono truncate text-gray-600">{previewStampId}</p>
                                          {showAdvocateName && (
                                            <p className="text-[5px] truncate text-gray-500">{user?.full_name?.split(' ')[0] || 'Advocate'}</p>
                                          )}
                                        </div>
                                      </div>
                                    );
                                  ...
                                  // LOGO_LEFT LAYOUT (QR Left) - TRANSPARENT
                                  if (stampLayout === "logo_left") {
                                    return (
                                      <div className="w-full h-full rounded-sm border-2 overflow-hidden flex" style={{ borderColor: brandColor, backgroundColor: 'transparent' }}>
                                        <div className="w-1/3 flex flex-col items-center justify-center py-1" style={{ backgroundColor: brandColor }}>
                                          ...
                                          <QRPatternPreview size="w-8 h-8" onColoredBg={true} />
                                          <p className="text-[5px] font-bold mt-1 text-white">VERIFIED</p>
                                        </div>
                                        <div className="flex-1 p-1.5 flex flex-col justify-center bg-white">
                                          <p className="text-[5px] text-gray-400">STAMP ID</p>
                                          <p className="text-[6px] font-bold truncate" style={{ color: brandColor }}>{previewStampId}</p>
                                          <p className="text-[5px] text-gray-500 mt-0.5">Date: {previewDate}</p>
                                          {showAdvocateName && (
                                            <>
                                              <div className="border-t border-gray-200 my-1" />
                                              <p className="text-[5px] text-gray-400">By:</p>
                                              <p className="text-[5px] font-bold" style={{ color: brandColor }}>{user?.full_name || 'Advocate'}</p>
                                            </>
                                          )}
                                        </div>
                                  ...
                                  // LOGO_RIGHT LAYOUT (QR Right) - TRANSPARENT
                                  if (stampLayout === "logo_right") {
                                    return (
                                      <div className="w-full h-full rounded-sm border-2 overflow-hidden flex" style={{ borderColor: brandColor, backgroundColor: 'transparent' }}>
                                        <div className="flex-1 p-1.5 flex flex-col justify-center bg-white">
                                          <p className="text-[6px] font-bold" style={{ color: brandColor }}>TLS VERIFIED</p>
                                          <p className="text-[5px] text-gray-400 mt-0.5">STAMP ID</p>
                                          <p className="text-[5px] font-mono truncate text-gray-700">{previewStampId}</p>
                                          <p className="text-[5px] text-gray-500">Date: {previewDate}</p>
                                          {showAdvocateName && (
                                            <p className="text-[5px] mt-0.5">By: <span style={{ color: brandColor }}>{user?.full_name || 'Advocate'}</span></p>
                                          )}
                                        </div>
                                        <div className="w-1/3 flex flex-col items-center justify-center py-1" style={{ backgroundColor: brandColor }}>
                                          <div className="bg-white rounded p-0.5 mb-1">
                                          ...
                                          <QRPatternPreview size="w-8 h-8" onColoredBg={true} />
                                          <p className="text-[4px] mt-1 text-white">Scan</p>
                                        </div>
                                      </div>
                                    );
                                  }
                                ...
                                {/* Resize handle */}
                                <div 
                                  className="absolute bottom-0 right-0 w-2 h-2 cursor-se-resize opacity-50"
                                  style={{ 
